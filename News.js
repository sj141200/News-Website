...
export default function News() {
  ...
  const getNews = async () => {
    let data = await fetch(
      `https://newsapi.org/v2/everything?q==${searchnews}&tesla&from=2023-05-26&sortBy=publishedAt&apiKey=ec56e25fe775444194d54b6b13b606a8&pageSize=${pageSize}&page=${currentPage}`
    );
  ...
  return (
    <><div className="container">
      <header className="header">
        <h1 className="header-title">Shubham News Network</h1>
    
        <h1>You are welcome to world biggest news network! </h1>
